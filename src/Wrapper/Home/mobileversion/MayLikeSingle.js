        ...
        <div className="w-[263px] h-[179px] bg-white shadow-[2px_2px_8px_rgba(0,0,0,0.12)] rounded-[20px]  py-[17px] mx-auto">
            <div className="flex items-center justify-between px-5">
                <div
                    ...
                    style={{
                        backgroundImage: `url(${data?.profilePhoto ? data?.profilePhoto : "https://cdn-icons-png.flaticon.com/512/194/194938.png"})`,
                    }}
                ></div>
                <div className="flex items-center gap-x-[10px]">
                    <div
                        className={`w-[44px] h-[44px] rounded-full flex justify-center items-center ${likeSent ? "bg-green-100" : "bg-[#FFDFF4]"}`}
                    ...
                    >
                        {likeSent ? (
                            ...
                            <img onClick={handleLikeProfile} src={loveIcon} alt="loveIcon" className="" />
                        )}
                    </div>
                    <div
                        className={`${
