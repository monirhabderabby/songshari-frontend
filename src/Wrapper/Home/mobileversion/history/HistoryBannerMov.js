...
export const HistoryBannerMov = () => {
  return (
    <div>
     ...
     <img src='https://i.ibb.co/x2L99Cr/Arrow-2.png' className='ml-20 mt-5'></img>
        ...
        <h1 className='font-bold text-black text-lg ml-8 mb-4 mt-12'>Our History</h1>
 ...
 <p className='text-sm'>Lorem ipsum dolor sit amet consectetur. Lorem quam cursus varius eu imperdiet.</p>
