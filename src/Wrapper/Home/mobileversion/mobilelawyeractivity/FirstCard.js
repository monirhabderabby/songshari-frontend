...
export const FirstCardMov = () => {
  ...
  <div className="stat grid lg:grid-cols-2">
    ...
    <div className="stat-figure text-primary">
     <img src='https://i.ibb.co/XzXQ8ck/ic-messages-1.png'></img>
    </div>
  </div>
  </div>
  <div className="stats shadow">
  ...
  <div className="stat grid lg:grid-cols-2">
    ...
    <div className="stat-figure text-primary">
     <img src='https://i.ibb.co/PtZvMKJ/circle-check.png'></img>
    </div>
  </div>
  </div>
  <div className="stats shadow">
  ...
  <div className="stat grid lg:grid-cols-2">
    ...
    <div className="stat-figure text-primary">
     <img src='https://i.ibb.co/PxjZyb3/off-close.png'></img>
    </div>
  </div>
  </div>
