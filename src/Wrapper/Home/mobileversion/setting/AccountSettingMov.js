...
export const AccountSettingMov = () => {
    ...
    const customExpandIcon = ({ isActive, onClick }) => (
        <i onClick={onClick} className={`fa-solid fa-angle-right mr-2 ${isActive && "rotate-90"}`}></i>
    );

    const memberServicesHeader = (
        <div className="setting-mov">
            <img src="https://i.ibb.co/FnGQ6bg/Vector.png" className="ml-[6px] mr-6" alt="Not Available"></img>
                ...
                <div className="grid grid-cols-6 mt-5 mb-10 he">
                    <div className="setting-mov">
                        <h1 className="mt-[-5px] whitespace-nowrap flex items-center">
                            <AiOutlineUsergroupAdd className="ml-8 mr-[22px] text-black text-xl" /> Connections
                        </h1>
                    </div>
                    <div></div>
                    <div></div>
            ...
            {role !== "member" && (
                <Link to={reviewsPath}>
                    <div className="grid grid-cols-6 mt-5 mb-10 he">
                        <div className="setting-mov">
                            <h1 className="mt-[-5px] whitespace-nowrap flex items-center">
                                <MdOutlineReviews className="ml-8 mr-[22px] text-black text-xl" /> My Reviews
                            </h1>
                        </div>
                        <div></div>
                        <div></div>
