    ...
    <div className='rounded-full bg-bottom-nav mt-4'>
      <div className='grid grid-cols-5 gap-4 bottom-bar'>
        <Link to='/mobileUpgrade'>
          <img src={member} alt="Not Available" className='w-8'></img>
        </Link>
        <img src={Shop} alt="Not Available" className='w-8'></img>
        <Link to='/'>
          <img src='https://i.ibb.co/d5yyNd6/512-512-Icon.png' alt="Not Available" className='w-8'></img>
        </Link>
        <img src={cart} alt='' className='w-8'></img>
        <Link to='/setting'><img src={cart} alt="Not Available" className='w-8'></img></Link>
      </div>
    </div>
  )
}
