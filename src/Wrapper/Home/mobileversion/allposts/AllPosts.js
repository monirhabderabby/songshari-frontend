...
export const AllPosts = () => {
    ...
    return (
        ...
        //                         )}
        //                         <p className="font-semibold font-fira text-[18px] text-[#333333] mr-[14px]">{post?.author?.firstName}</p>

        //                         <div>
        //                             <span className="text-[12px] font-bold text-[#333333]  ml-[138px]">20 min</span>
        //                         </div>
        //                     </div>
