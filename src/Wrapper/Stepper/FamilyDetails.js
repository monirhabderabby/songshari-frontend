...
const FamilyDetails = ({ setPage }) => {
    ...
    // Redux api
    const [updateFamilyDetails, { data: response, isLoading }] = useUpdateFamilyDetailsMutation();
                    ...
                    {fatherStatus === "yes" && (
                        <>
                            ...
                            <section>
                                <div className="flex items-center bg-gray-100 w-full rounded-lg mt-3 lg:mt-0">
                                    <CreatableSelect
                                        onChange={val => setFatherEducationalQualification(val.value)}
                                        type="text"
                            ...
                            <section>
                                <div className="flex items-center bg-gray-100 p-3 w-full rounded-lg mt-3 lg:mt-0">
                                    ...
                                    >
                                        ...
                                        <option value={"100000-150000 BDT"}>100000-150000 BDT</option>
                                        <option value={"150000-200000 BDT"}>150000-200000 BDT</option>
                                        <option value={"200000-250000 BDT"}>200000-250000 BDT</option>
                    ...
                    {motherStatus === "yes" && (
                        <>
                            ...
                            <section>
                                <div className="flex items-center bg-gray-100 w-full rounded-lg mt-3 lg:mt-0">
                                    <CreatableSelect
                                        onChange={val => setMotherEducationalQualification(val.value)}
                                        type="text"
                                        placeholder="Select Education"
                                        options={[
                                            {
