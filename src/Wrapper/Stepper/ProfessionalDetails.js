...
export const ProfessionalDetails = ({ setPage }) => {
    ...
    const [setProfessionalDetails, { data: response, isLoading }] = useSetProfessionalDetailsMutation();
    ...
    const onSubmit = async data => {
        ...
        data.professions.map((p, index) => (p.specialAchievementMoment = addedAchievementMoment[index]));
                ...
                <section className="md:w-full w-64 mx-auto grid grid-cols-1 md:grid-cols-2 gap-3 lg:grid-cols-3">
                    ...
                    <section>
                        <div className="flex items-center bg-gray-100 p-3 w-full rounded-lg mt-3 lg:mt-0">
                            ...
                            <label htmlFor="specialAchievementMoment" className="outline-none h-full text-sm text-gray-400 bg-gray-100">
                                {professionalAchievementMoment ? (
                                    <>
                                        <span className="text-green-400">{achievementMomentName ? achievementMomentName : "Moments added"}</span>
                                    </>
                                ) : (
                            ...
                            <section className="col-span-1 md:col-span-2 lg:col-span-3 grid grid-cols-3 gap-3" key={field.id}>
                                ...
                                <section>
                                    <div className="flex items-center bg-gray-100 p-3 w-full rounded-lg mt-3 lg:mt-0">
                                        ...
                                        <input
                                            {...register(`professions.${index}.specialAchievementMoment`)}
                                            type="file"
