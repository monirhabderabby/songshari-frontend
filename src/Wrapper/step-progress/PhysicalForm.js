...
import { useLoginAsMemberMutation, useSetPhysicalDetailsMutation } from "../../Redux/features/userInfo/userApi";
...
const PhysicalForm = () => {
    ...
    const [physicaldetails, { data: response, isLoading }] = useSetPhysicalDetailsMutation();
