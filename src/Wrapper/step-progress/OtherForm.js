...
import { useLoginAsMemberMutation, useSetOthersDetailsMutation } from "../../Redux/features/userInfo/userApi";
...
const OtherForm = () => {
    ...
    const [otherdetails, { data: response, isLoading }] = useSetOthersDetailsMutation();
                        ...
                        <div className="py-10">
                            ...
                            <div>
                                <form className="w-64 mx-auto" onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <input
                                        type="submit"
                                        value={loading || isLoading ? "Loading..." : "Finish"}
                                        className=" mt-4"
                                    />
                                </form>
