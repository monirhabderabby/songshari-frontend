...
function getSteps() {
    return ["Personal information", "Professional information", "Educational information", "Physical information", "Others information"];
}
            ...
            <Stepper alternativeLabel activeStep={activeStep}>
                {steps.map((step, index) => {
                    ...
                    if (isStepOptional(index)) {
                        labelProps.optional = <Typography variant="caption" align="center" style={{ display: "block" }}></Typography>;
                    }
