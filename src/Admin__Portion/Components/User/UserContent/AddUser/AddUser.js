...
const AddUser = () => {
    return (
        <div className='font-Inter text-sm'>
            ...
            {/* User Search */}
            <div className='flex mx-auto items-center w-[492px] h-[52px] bg-[#FFFFFF] border border-[#FFE8F3] py-[14px] px-[21px] rounded-lg gap-6'>
                <FiSearch className='text-[#353751] p-6' />
                <input className='font-poppins font-normal text-base text-[#AAAAAA] focus: outline-none h-full w-full' type="search" name="" id="" placeholder='Search user name' />
            </div>
            ...
            <div className='w-[523px] mx-auto mt-10 px-[21px] py-[31px] rounded-[10px] shadow bg-[#FFFFFF]'>
                <form>
                    ...
                    <div className='mt-6'>
                        ...
                        <div className=' flex h-12 items-center border border-[#D0D5DD] rounded-lg mt-1'>
                            <div className='w-[15%] pl-4'>
                                <select id="countryCode" className=" text-[#101828] text-base focus:outline-none block w-full h-full">
                            ...
                            <div className="w-[85%]">
                                <input type="text" id="phoneNumber" className="text-[#667085] text-base block w-full h-full focus:outline-none " placeholder="+880 177 004-5304" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className="flex items-center justify-center w-full mt-1 shadow-lg rounded-[10px] h-[99px] cursor-pointer">
                            <label className='cursor-pointer'>
                                ...
                                <input id="passportPhoto" type="file" className="hidden" />
                            </label>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col mt-6 font-medium text-[#344054]'>
                        ...
                        <input className='border border-[#D0D5DD] shadow rounded-lg focus: outline-none py-3 px-4 mt-1 text-base text-[#667085]' type="number" name='registration' id='registration' placeholder='0000 0000 0000 0000' />
                    </div>
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className="flex items-center justify-center w-full mt-1 shadow-lg rounded-[10px] h-[99px] cursor-pointer">
                            <label className='cursor-pointer'>
                                ...
                                <input id="licencePhoto" type="file" className="hidden" />
                            </label>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col mt-8 font-medium text-[#344054]'>
                        ...
                        <textarea cols="30" rows="10" className='border border-[#000000] shadow rounded-lg focus: outline-none py-3 px-4 mt-1 h-[99px] text-xs text-[#757575]' type="text" name='location' id='location' placeholder='Dhaka, Bangladesh'></textarea>
                    </div>
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className=' flex h-12 items-center mt-[15px]'>
                            <div>
                                <select id="lawyerCategory" className="font-medium text-base text-[#222222] focus:outline-none block w-full h-full">
                                    <option selected>Genarel</option>
                                    <option value="general1">Genarel1</option>
                                    <option value="general2">Genarel2</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className=' flex h-12 items-center mt-[15px]'>
                            <div>
                                <select id="maritalStatus" className="font-medium text-base text-[#222222] focus:outline-none block w-full h-full">
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className=' flex h-12 items-center mt-[15px]'>
                            <div>
                                <select id="citizenship" className="font-medium text-base text-[#757575] focus:outline-none block w-full h-full">
                                    <option selected>Select</option>
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className=' flex h-12 items-center mt-[15px]'>
                            <div>
                                <select id="zodiacSign" className="font-medium text-base text-[#757575] focus:outline-none block w-full h-full">
                                    <option selected>Select</option>
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className='flex gap-2 mt-[15px]'>
                            <div>
                                <select id="selectPosition" className="font-medium text-base text-[#757575] focus:outline-none block w-full h-full">
                            ...
                            <div>
                                <select id="selectInstitute" className="font-medium text-base text-[#757575] focus:outline-none block w-full h-full">
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className='grid grid-cols-3 gap-2 mt-[29px]'>
                            ...
                            <div>
                                <select id="instituteName" className="font-medium text-[10px] text-[#757575] focus:outline-none block w-full h-full">
                            ...
                            <div>
                                <select id="department" className="font-medium text-[10px] text-[#757575] focus:outline-none block w-full h-full">
                            ...
                            <div>
                                <select id="studyField" className="font-medium text-[10px] text-[#757575] focus:outline-none block w-full h-full">
                            ...
                            <div>
                                <select id="cgpa" className="font-medium text-[10px] text-[#757575] focus:outline-none block w-full h-full">
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className=' flex h-12 items-center mt-[15px]'>
                            <div>
                                <select id="height" className=" font-medium text-base text-[#757575] focus:outline-none block w-full h-full">
                                    <option selected>select</option>
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className=' flex h-12 items-center mt-[15px]'>
                            <div>
                                <select id="weight" className=" font-medium text-base text-[#757575] focus:outline-none block w-full h-full">
                                    <option selected>select</option>
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className=' flex h-12 items-center mt-[15px]'>
                            <div>
                                <select id="ancestry" className=" font-medium text-base text-[#757575] focus:outline-none block w-full h-full">
                                    <option selected>select</option>
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className=' flex h-12 items-center mt-[15px]'>
                            <div>
                                <select id="skinTone" className=" font-medium text-base text-[#757575] focus:outline-none block w-full h-full">
                                    <option selected>select</option>
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className=' flex h-12 items-center mt-[15px]'>
                            <div>
                                <select id="monthlyIncome" className="font-medium text-base text-[#757575] focus:outline-none block w-full h-full">
                                    <option selected>select</option>
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className=' flex h-12 items-center mt-[15px]'>
                            <div>
                                <select id="homeTown" className=" font-medium text-base text-[#757575] focus:outline-none block w-full h-full">
                                    <option selected>select</option>
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className=' flex h-12 items-center mt-[15px]'>
                            <div>
                                <select id="currentCity" className="font-medium text-base text-[#757575] focus:outline-none block w-full h-full">
                                    <option selected>select</option>
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className='flex gap-2'>
                            ...
                            <div>
                                <select id="sister" className="font-medium text-base text-[#757575] focus:outline-none block w-full h-full">
                    ...
                    <div className='mt-8 font-medium text-[#344054]'>
                        ...
                        <div className=' flex h-12 items-center mt-[15px]'>
                            <div>
                                <select id="hobby" className="focus:outline-none block w-full h-full font-medium text-base text-[#757575]">
                                    <option selected>select</option>
