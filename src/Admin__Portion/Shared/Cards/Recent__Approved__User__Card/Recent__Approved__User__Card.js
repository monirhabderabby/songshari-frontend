...
export const Recent__Approved__User__Card = () => {
    return (
        <div>
            <div class="w-[385px] h-[222px] bg-[#51BD7C] rounded-[8px] px-[35px] py-[31px]">
                <div class="flex gap-x-[24px]">
                    <img
                        class="w-[85px] h-[85px] rounded-full"
                    ...
                    <div class="flex flex-col gap-y-[18px]">
                        <h1 class="text-[#FFFFFF] text-[24px] leading-[29px] font-medium">Jhon William</h1>
                        <p class="text-[#FFFFFF] text-[20px] leading-[24px] font-medium">Age: 26</p>
                        <button class="w-[135px] h-[37px] mt-[20px] flex justify-center items-center bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] text-white rounded-[4px]">
                            View Request
                        </button>
                    </div>
                </div>
