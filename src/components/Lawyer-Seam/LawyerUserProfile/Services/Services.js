    ...
    return (
        <div className='mt-[70px]'>
                    ...
                    >
                        ...
                        <div className='flex justify-between'>
                            ...
                            <div className='flex items-center gap-4'>
                                ...
                                <button className='text-sm text-white font-semibold leading-[18px] px-5 py-1 rounded bg-[#E41272]'>
                                    View
                                </button>
                            </div>
                        </div>
            ...
            <div className='my-12 md:my-16 lg:my-28 flex justify-center'>
                <button className='px-10 py-4 text-white text-xl md:text-2xl font-bold leading-8 rounded bg-[#E41272]'>
                    ADD NEW SERVICE
                </button>
            </div>
        </div>
