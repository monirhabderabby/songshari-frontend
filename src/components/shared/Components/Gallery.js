...
export const Gallery = () => {
      ...
      <div className="w-full grid grid-cols-3 gap-[40px] max-w-[1200px] mx-auto px-[10px]">
        {loaderArr.map((p, index) => {
          return (
            <div
              key={p}
              className={`w-full max-h-[424px] bg-gray-200 rounded-[15px] animate-pulse ${
  ...
  return (
    <div className="hidden lg:block">
      ...
      <p className="text-[#333333] font-semibold font-fira text-[32px] mt-[60px] mb-[30px] max-w-[1200px] mx-auto px-[20px]">
        All Photos
      </p>
      {content}
    </div>
