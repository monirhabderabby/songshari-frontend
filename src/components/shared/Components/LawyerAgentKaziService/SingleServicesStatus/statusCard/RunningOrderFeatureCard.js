...
const RunningOrderFeatureCard = ({ price, deadline, role }) => {
  ...
  const orderID = useSelector(
    (state) =>
      state.persistedReducer?.orderInfo?.runningOrder?.currentOrderIdFOrCancle
  );
        ...
        <Collapse in={expanded} timeout="auto" unmountOnExit>
          <CardContent>
            ...
            <p className="text-[14px] font-normal font-sans mt-[15px]">
              ...
              Enterprises. Experience a web design company who has been
              delivering progressive and result-oriented solutions for... Read
              more
            </p>
            <section className="mt-[23px] w-full flex justify-between items-center">
              <h4 className="text-[11px] font-semibold font-sans">
                Bangladesh
              </h4>
