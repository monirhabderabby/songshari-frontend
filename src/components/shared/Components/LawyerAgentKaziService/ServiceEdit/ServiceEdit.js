...
export const ServiceEdit = ({ responsive }) => {
    ...
    if (currentRole.includes("lawyer")) {
        responsive ? (redirectPath = "/mobileLawyerServices") : (redirectPath = "/lawyerProfile/lawyerService");
    } else if (currentRole.includes("kazi")) {
        responsive ? (redirectPath = "/mobileKaziServices") : (redirectPath = "/kaziProfile/kaziServices");
    } else if (currentRole.includes("agent")) {
        responsive ? (redirectPath = "/mobileAgentServices") : (redirectPath = "/agentProfile/agentService");
    }
