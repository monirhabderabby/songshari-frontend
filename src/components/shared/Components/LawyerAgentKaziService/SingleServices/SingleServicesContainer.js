...
import FadeInFadeOutAnimation from "../../../../../assets/utilities/Animation/fadeInFadeOut/FadeInFadeOutAnimation";
                        ...
                        <div className="flex justify-between items-start">
                            <div className="max-w-[327px] md:max-w-[819px]">
                                ...
                                <div>
                                    ...
                                    <FadeInFadeOutAnimation delay={0.5}>
                            ...
                            <Modal title={null} closable={false} open={prizeReviewModalVisible} onCancel={handlePrizeReviewModalCancel} footer={null}>
