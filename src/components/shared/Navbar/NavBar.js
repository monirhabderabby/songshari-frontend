                ...
                <div className="col-span-1">
                    <ul className={'flex justify-end items-center gap-6 h-32'}>
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <span className={`${NavBarCSS.tooltip} rounded-xl z-50 shadow-lg px-3 py-1 text-white text-xs font-bold whitespace-nowrap uppercase mt-[66px]`}
                                    ...
                                    <div className="flex flex-col z-50">
                                        ...
                                        <Link className="text-center my-1" to="/register-member">Register as Member</Link>
                                        <Link className="text-center my-1" to="/regAsProfessional">Register as a Professional</Link>
                                    </div>
                                </span>
                            </div>
                        </li>
                        ...
                        <li className=" text-center">
                            <select className="text-[#ff3366] text-2xl font-medium font-fira pr-2 relative top-1 border-none cursor-pointer" name="lan" id="lan">
