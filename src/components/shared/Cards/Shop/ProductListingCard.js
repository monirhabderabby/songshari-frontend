...
const ProductListingCard = ({ product }) => {
    ...
    return (
        <div className="pt-16" onClick={() => navigate(`/shop/singleProduct/${_id}`)}>
            <div className="w-full lg:w-[615px] h-[260px] lg:h-[320px] bg-[linear-gradient(104.63deg,#75204C_1.61%,_#360C41_97.81%)] rounded-[18px] px-[20px] lg:px-[35px] py-[31px] relative shadow-[2px_2px_10px_2px_rgba(0,0,0,0.12)]">
