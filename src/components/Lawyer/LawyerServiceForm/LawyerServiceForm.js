...
import { ServicePhotoUploadContainer } from "../../shared/Components/LawyerAgentKaziService/ServicePhotoUploadContainer";
        ...
        <div>
            ...
            <form className="mb-52 max-w-4xl px-4 border mx-1 md:mx-2 lg:mx-auto bg-[#FFFFFF]" onSubmit={handleSubmit(onSubmit)}>
                <div className="flex justify-between items-center mt-3 mb-5">
                    <h2 className="text-2xl md:text-3xl text-[#32353B] leading-8">Add Your Lawyer Service</h2>
