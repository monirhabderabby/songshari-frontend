...
// Components
import LawyerActivityRunningCaseCard from "../../../shared/Cards/Lawyer/LawyerActivityRunningCaseCard";

const LawyerActivityRunningCase = () => {
...
export default LawyerActivityRunningCase;
