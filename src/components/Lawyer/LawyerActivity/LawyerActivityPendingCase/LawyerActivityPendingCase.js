...
// Components
import LawyerActivityPendingCaseCard from "../../../shared/Cards/Lawyer/LawyerActivityPendingCaseCard";

const LawyerActivityPendingCase = () => {
    ...
    <div className="mb-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-12 mb-16">
        {pendingCasesInfo.map((caseInfo) => (
          <LawyerActivityPendingCaseCard key={caseInfo.id} {...{ caseInfo }} />
        ))}
      </div>
...
export default LawyerActivityPendingCase;
