...
import LawyerActivityCompletedCaseCard from "../../../shared/Cards/Lawyer/LawyerActivityCompletedCaseCard";

const LawyerActivityCompletedCase = () => {
    ...
    <div className="mb-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-12 mb-16">
        {completedCasesInfo.map((singleCase) => (
          <LawyerActivityCompletedCaseCard
            key={singleCase.id}
            {...{ singleCase }}
          />
        ))}
...
export default LawyerActivityCompletedCase;
