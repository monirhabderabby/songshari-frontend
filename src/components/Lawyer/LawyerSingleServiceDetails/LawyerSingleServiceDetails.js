...
const LawyerSingleServiceDetails = () => {
    ...
    const { service } = data || {};
    const { _id, title, description, photos, recuirements, price, extraOffer } = service || {};
            ...
            <div>
                ...
                <div className="flex justify-between items-start">
                    <div className="max-w-[819px]">
                        <LawyerSingleServiceImages {...{ photos }} />
                        <div>
                        ...
                        <div>
                            ...
                            <div>
                                {serviceDetails.reviews.map(review => (
                                    <LawyerSingleServiceReviewCard key={review.id} {...{ review }} />
                                ))}
                            </div>
                        </div>
                    </div>
