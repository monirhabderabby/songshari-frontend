...
import LawyerReviewBelowThreeStarCard from "../../../shared/Cards/Lawyer/LawyerReviewBelowThreeStarCard";

const LawyerReviewBelowThreeStar = ({ belowThreeStarReviews }) => {
  return (
          ...
          <Swiper slidesPerView={"auto"} spaceBetween={30}>
            {belowThreeStarReviews.map((review) => (
              <SwiperSlide key={review.id} className="w-[348px]">
                <LawyerReviewBelowThreeStarCard {...{ review }} />
              </SwiperSlide>
            ))}
          </Swiper>
        </div>
...
export default LawyerReviewBelowThreeStar;
