...
const PendingOrder = () => {
    ...
    const pendingOrdersInfo = [
        { id: 1, name: "Mr. Strange", serviceName: "A Example lawyer service for the married person", date: " Sep 8th, 2023" },
        { id: 2, name: "Mr. Strange", serviceName: "A Example lawyer service for the married person", date: " Sep 8th, 2023" },
        { id: 3, name: "Mr. Strange", serviceName: "A Example lawyer service for the married person", date: " Sep 8th, 2023" },
    ]
    ...
    return (
        <div className='mb-12 md:mb-16 lg:mb-28'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-12'>
                {
                    pendingOrdersInfo.map(order => <div
                        key={order.id}
                        className="px-6 lg:px-10 py-6 rounded-lg"
                        style={{ backgroundImage: "linear-gradient(180deg, #FFEAF3 0%, #EDF0FF 100%)", boxShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)" }}>
                        <p className='text-lg leading-6 tracking-tight mb-2'>
                            {order.name}
                        </p>
