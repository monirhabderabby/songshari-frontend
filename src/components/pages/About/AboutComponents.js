            ...
            <div className='container mx-auto'>
                <div className='flex justify-center'>
                    <div className='text-center md:w-2/4'>
                        <h3 className='' style={{ color: '#5650ce', fontSize: '24px' }}>How We’re different</h3>
                        <h1 className='mt-6 mb-8 text-2xl md:text-6xl font-extrabold'>Why Choose Us?</h1>
                ...
                <div className='my-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 justify-center'>
                    {
                        checkArray.map(i => {
                            return (
                                <div key={i + 1}>
