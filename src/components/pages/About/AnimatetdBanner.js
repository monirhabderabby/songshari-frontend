...
const AnimatetdBanner = () => {
    return (
        <div className='bg-[#5736cb] relative h-96 overflow-hidden mt-5'>
            ...
            <div className='container mx-auto flex items-center'>
                <div className='grid grid-cols-1 md:grid-cols-2 items-center h-full w-full justify-between'>
                    <div className='text-center md:text-left'>
                        <h2 className='mb-4 text-2xl md:text-5xl font-bold text-white'>Best Ways to Find Your </h2>
                        <h2 className='mb-4 text-2xl md:text-5xl font-bold text-white'>True Sole Mate</h2>
                        <button
                            type="submit"
