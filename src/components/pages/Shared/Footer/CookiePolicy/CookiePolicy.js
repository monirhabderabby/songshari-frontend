    ...
    const data = [
        {
            ...
            footer: "For the exhaustive list of cookies we collect see the List of cookies we collect section.",
            feature: [
                {
                    id: 1,
                    text: "name",
    ...
    return (
        <div>
            ...
            <div className="content max-w-[1200px] mx-auto mt-[10px] font-Inter mb-[50px] px-[16px]">
                <h1 className="text-[24px] font-semibold">Privacy and Cookie Policy,</h1>
                <p className="mt-[15px] text-[16px]">
                    This privacy policy sets out how this website (hereafter "the Store") uses and protects any information that you give the Store
                    while using this website. The Store is committed to ensuring that your privacy is protected. Should we ask you to provide certain
                    information by which you can be identified when using this website, then you can be assured that it will only be used in
                    accordance with this privacy statement. The Store may change this policy from time to time by updating this page. You should check
