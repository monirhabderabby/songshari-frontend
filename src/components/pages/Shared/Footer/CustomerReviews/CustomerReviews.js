        ...
        {reviewsArray.map((review) => {
          return (
            <div className="flex gap-x-[23px] ring-1 ring-pink-500 rounded p-2 md:p-4">
              <img
                src={
                  "https://www.gamespot.com/a/uploads/scale_landscape/1578/15789737/4001018-0.jpg"
                }
              ...
              <div className="max-w-[600px]">
                ...
                <p className="text-[#181818] text-[16px] font-normal font-Nunito">
                  This was awesome. The journey was awesome. I just ordered this
                  service and the rest of the things is being solved by my kazi.
                  Best wishes for the kazi halim. Wish him to be the best kazi
                  at shongshari.
                </p>
