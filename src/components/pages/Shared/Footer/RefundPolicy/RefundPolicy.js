    ...
    <div>
      ...
      <div className="content max-w-[1200px] mx-auto mt-[10px] font-Inter mb-[50px] px-[16px]">
        ...
        <p className="mt-[15px] text-[16px]">
          Thank you for shopping with [Your Company Name]. We strive to provide
          the best customer experience and satisfaction. If you are not entirely
        ...
        <section>
          ...
          <p>
            ...
            [contact email/phone number]. Provide your order number and a
            detailed explanation of the reason for the refund request. We may
            require additional information or evidence to process your request.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>
            Once your refund request is received and inspected, we will notify
            you of the approval or rejection of your refund. If approved, your
            refund will be processed within [number of days] days and a credit
        ...
        <section>
          ...
          <p>
            ...
            please check your bank account again. Then, contact your credit card
            company or payment provider as processing times may vary. If you
            have taken these steps and still have not received your refund,
            please reach out to our customer support team for further
            assistance.
          </p>
        </section>
        <section>
          ...
          <p>
            Shipping costs are generally non-refundable. If you receive a
            refund, the original shipping cost will be deducted from your refund
        ...
        <section>
          ...
          <p>
            If you are eligible for a refund, you will be responsible for the
            cost of return shipping unless the return is due to our error. We
            recommend using a trackable shipping service and obtaining a
            shipping receipt as proof of shipment.
          </p>
        </section>
        <section>
