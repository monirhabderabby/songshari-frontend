            ...
            {profile && (
                <div className="h-[400px]  relative group overflow-hidden Suggested-card  md:hidden ml-4 mr-4 mb-4">
                    <img
                        ...
                        alt="profile"
                    />
                    <div className="absolute h-[100px] w-full top-[300px] right-0 inset-0 bg-black opacity-90 text-white px-4 py-2 font-serif group-hover:top-[370px] transition ease-out duration-500 rounded-bl-[12px] rounded-br-[12px]">
                        <div className="flex gap-x-4 items-center">
