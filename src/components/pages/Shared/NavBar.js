...
import happyStory from "../../../assets/images/NavIcons/Blog.svg";
...
const NavBar = ({ bg }) => {
    ...
    const allMenu = [
        ...
        { id: 3, to: "/happyStories", icon: happyStory, tooltip: "Happy Stories" },
    ...
    return (
        <>
            <header
                className={`${bg ? "bg-transparent" : "bg-white"} fixed w-full hidden lg:block top-0 lg:h-[90px] z-50 shadow-md body-font ${
                    NavBarCSS.navbar
                }  transition-transform duration-1000 transform ${showNav ? "" : "-translate-y-full"}`}
            >
                                        ...
                                        <div style={{ marginLeft: "15px" }} className="flex flex-col items-center">
                                            <img
                                                className={`hover:rotate-[360deg] duration-[2000ms] w-[50px] h-[50px] ${
                                                    menu.tooltip === "Happy Stories" && "w-[20px] h-[20px]"
                                                }`}
                                                src={menu.icon}
                                                alt="Not Available"
                                            />
