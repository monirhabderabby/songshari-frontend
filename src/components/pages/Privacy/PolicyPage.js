...
export const PolicyPage = () => {
  ...
  return (
    <div className="text-[#33475B]">
      <h1 className="text-[32px]  leading-[44px] font-bold mb-[20px]">
        Privacy Policy
      </h1>
      ...
      <p className="mt-[43px] mb-[10px] text-[15px] font-normal">
        ...
        During registration, a user is required to give their contact
        ...
        more personalized experience on our site. The site collects personal
        information necessary to respond to your requests for customized
        matrimonial services and to allow you to use the resources available on
        our website.
      </p>
      <p className="mb-[40px] text-[15px] font-normal">
        Personal information includes, but is not limited to, name, physical
        address, email address, date of birth, religion, time of birth, caste,
        fathers name, mothers name, age and any other information that itself
        identifies or, when tied to the above information, may identify you as a
        specific individual.
      </p>
      {content?.map((content) => {
        return (
          <div key={content.id} className="mb-[40px]">
            <h3 className="text-[#33475B] mb-[8px] font-bold text-[22px]">
              {content?.heading}
            </h3>
