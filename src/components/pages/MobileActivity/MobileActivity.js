...
import { useAddUserPostMutation } from "../../../Redux/features/Post/postApi";
...
const MobileActivity = () => {
    ...
    return (
        <section className="max-w-[1024px] mx-auto h-screen">
            ...
            <div className="bg-[#FFFFFF] rounded-md pb-[5px] my-[10px] px-6 sticky top-0 drop-shadow-lg">
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="border-b border-[rgba(0, 0, 0, 0.2)] pt-[30px] flex">
                        <img className="w-[40px] h-[40px] rounded-full mr-5" src={profile} alt="Not Available" />
                        <textarea
                            {...register("postText")}
                            id="postText"
