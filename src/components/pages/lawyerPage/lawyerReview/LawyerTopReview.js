...
import { topReview } from "./LawyerReviewData"
const LawyerTopReview = () => {
  return (
    <>
              ...
              topReview.map(profile => (
                <SwiperSlide key={profile._id}>
                  <div className="bg-[#FFFFFF] py-4 text-center px-[25px]">
                    ...
                    <h1 className="text-sm mt-[10px] text-[#E41272] font-bold">
                      Jenny Wilson
                    </h1>
                    <h1 className="text-sm mt-[10px] text-[#252B42] font-bold">
                      Grower.io
                    </h1>
                  </div>
