    ...
    return (
        <div className="flex justify-center items-center">
            <div>
                <div>
                    <img
                        className="w-[847px] h-[294px] md:h-[444px] lg:h-[454px] rounded-md border border-gray-100 mb-2"
                        src={
                            selectedImage
                                ? selectedImage
                ...
                <div>
                    <SingleSuccessStoryImagesCard {...{ setSelectedImage, selectedImage, attachments }} />
                </div>
            </div>
        </div>
    );
