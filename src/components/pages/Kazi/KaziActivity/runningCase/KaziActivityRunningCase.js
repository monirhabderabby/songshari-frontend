...
// Components
import KaziActivityRunningCaseCard from "../../card/KaziActivityRunningCaseCard";

const KaziActivityRunningCase = () => {
    ...
    return (
        <div className="mb-24">
            <h1 className="text-[#333333] text-3xl leading-8 font-medium font-Inter mb-10">Running Case</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-12 mb-16">
                {runningCasesInfo.map(singleCase => (
                    <KaziActivityRunningCaseCard key={singleCase.id} {...{ singleCase }} />
                ))}
            </div>
...
export default KaziActivityRunningCase;
