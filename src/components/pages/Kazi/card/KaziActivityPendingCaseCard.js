...
const KaziActivityPendingCaseCard = ({ caseInfo }) => {
    return (
        <div className="text-white px-6 lg:px-10 py-6 rounded-lg bg-[linear-gradient(180.78deg,#40268B_-20.3%,#513A9C_99.3%)] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] ">
            ...
            <p className="text-xl font-semibold font-Nunito leading-7 tracking-tight mb-3">{caseInfo.serviceName}</p>
...
export default KaziActivityPendingCaseCard;
