...
const KaziActivityRunningCaseCard = ({ singleCase }) => {
    return (
        <div className="text-white p-8 rounded-[20px] bg-[linear-gradient(180deg,#6A248A_0%,#503B9C_95.31%,#654CC7_100%)]">
            <button className="bg-[#E41272] rounded-xl px-4 py-3 text-white font-semibold leading-6 mb-3">{singleCase.category}</button>
...
export default KaziActivityRunningCaseCard;
