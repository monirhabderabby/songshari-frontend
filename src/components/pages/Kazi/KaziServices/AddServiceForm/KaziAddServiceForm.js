    ...
    return (
        <div>
            ...
            <form className="mb-52 max-w-4xl px-4 border mx-1 md:mx-2 lg:mx-auto bg-[#FFFFFF]" onSubmit={handleSubmit(onSubmit)}>
                <h2 className="text-2xl md:text-3xl text-[#32353B] mt-1 mb-5 leading-8">Add Your Kazi Service</h2>
                ...
                >
                    <input type="text" className="col-span-10" {...register("serviceShortDescription")} placeholder="I can do" />
                ...
                <div className="mb-7">
                    <label htmlFor="deliveryTime" className="text-xs font-bold leading-5 text-[#707276] ml-1 block uppercase">
                ...
                <div className="mb-12 grid grid-cols-2 gap-8">
                    <div>
                        <label htmlFor="category" className="text-xs font-bold leading-5 text-[#707276] ml-1 block uppercase">
                            Category
                        </label>
                        <select
                            name="category"
                    ...
                    <div>
                        <label htmlFor="subCategory" className="text-xs font-bold leading-5 text-[#707276] ml-1 block uppercase">
                            Subcategory
                        </label>
                        <select
                            name="subCategory"
                ...
                <div className="mt-8 mb-14">
                    <label htmlFor="fileUpload" className="text-xs font-bold leading-5 text-[#707276] ml-1 block uppercase">
                ...
                <div className="mb-20">
                    ...
                    <div className="grid grid-cols-12 py-2 px-3 border border-[#707276] rounded">
                        <input type="text" name="addOnServiceDetail" className="col-span-8" {...register("addOnServiceDetail")} placeholder="I can" />
                        <div className="col-span-2 flex items-center gap-3">
                ...
                <p className="w-11/12 mx-2 text-xs leading-[17px] lowercase text-[#707276] mb-16">
                    I confirm that I am able to deliver this service to Buyers within the delivery time specified. I will update or pause my Offer if
                    I can no longer meet this delivery time. I understand that late delivery will adversely affect my rankings on PPH and will entitle
