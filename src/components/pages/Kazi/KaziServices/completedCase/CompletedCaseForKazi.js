...
import KaziCompletedCaseCard from "../../card/KaziCompletedCaseCard";

const CompletedCaseForKazi = () => {
        ...
        <div className="mb-12 md:mb-16 lg:mb-28">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-12">
                {completedCasesInfo.map(singleCase => (
                    <KaziCompletedCaseCard key={singleCase.id} {...{ singleCase }} />
                ))}
            </div>
        </div>
    );
...
export default CompletedCaseForKazi;
