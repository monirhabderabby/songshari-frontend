...
const KaziSingleServicePrizeReviewDetails = ({ serviceDetails }) => {
    return (
        <div className="w-[351px] rounded-xl bg-[linear-gradient(180deg,#DE298C_0%,#A52DC7_100%)] shadow-[2px_2px_8px_rgba(0,0,0,0.12)] py-8 px-4 text-white">
            ...
            <p className="text-sm font-semibold uppercase mb-6">Review : {serviceDetails.review}</p>
            <div className="mb-12">
            ...
            <div className="flex justify-between items-center">
                ...
                <button className="font-bold w-[92px] py-[6px] text-black bg-white rounded-xl shadow-[2px_2px_8px_rgba(0,0,0,0.1)]">Delete</button>
            </div>
        </div>
    );
};

export default KaziSingleServicePrizeReviewDetails;
