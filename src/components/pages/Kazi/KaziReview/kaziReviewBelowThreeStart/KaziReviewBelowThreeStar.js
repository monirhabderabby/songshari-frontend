...
// components
import KaziReviewBelowThreeStarCard from "../../card/KaziReviewBelowThreeStarCard";

const KaziReviewBelowThreeStar = ({ belowThreeStarReviews }) => {
    return (
                    ...
                    <Swiper slidesPerView={"auto"} spaceBetween={30}>
                        {belowThreeStarReviews.map(review => (
                            <SwiperSlide key={review.id} className="w-[348px]">
                                <KaziReviewBelowThreeStarCard {...{ review }} />
                            </SwiperSlide>
                        ))}
                    </Swiper>
                </div>
...
export default KaziReviewBelowThreeStar;
