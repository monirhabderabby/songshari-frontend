                    ...
                    <div className="w-full h-full flex justify-between">
                        <button
                            className={`flex-1 text-gray-800 rounded-tl-[4px] rounded-bl-[4px] font-medium text-[15px] duration-200 ${
                                page === 1 && "bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] text-white font-bold"
                            }`}
                            onClick={() => setPage(1)}
                        >
                            Info
                        ...
                        <button
                            className={`flex-1 text-gray-800 rounded-tr-[4px] rounded-br-[4px] font-medium duration-200 text-[15px] ${
                                page === 2 && "bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] text-white font-bold"
                            }`}
                            onClick={() => setPage(2)}
                        >
                            Connection
