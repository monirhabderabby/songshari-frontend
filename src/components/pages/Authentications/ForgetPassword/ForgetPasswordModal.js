    ...
    return (
        open && (
            <>
                ...
                <div className="rounded w-[400px] space-y-4 bg-white p-6 absolute top-1/2 left-1/2 z-20 -translate-x-1/2 -translate-y-1/2">
                    <h2 className=" text-3xl font-extrabold text-gray-900">Forget your password?</h2>
                    <p>we'll email you a link to reset your password</p>
                    <form>
                        <div className="flex items-center bg-gray-100 p-2 w-full rounded-xl">
                            <input type="text" className="flex-1 outline-none h-full bg-transparent text-sm text-gray-400" placeholder="Email" />
                        </div>
                        <input
                            type="submit"
