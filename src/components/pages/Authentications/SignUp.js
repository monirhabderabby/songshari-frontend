...
import { MdLockOutline, MdPhone, MdWorkOutline } from "react-icons/md";
...
const Signup = () => {
  ...
  useEffect(() => {
    if (response) {
      ...
      dispatch(
        loadInitialverificationData(response?.data?.user?.isEmailVerified)
      );
      reset();
    }
  ...
  const onSubmit = async (data) => {
    ...
    if (!dateOfBirth) {
      setCustomError("Date of birth is required");
      return;
    }
    if (!gender) {
      setCustomError("Gender is required");
      return;
    }
    if (!hometown) {
      setCustomError("Hometown is required");
      return;
    }
    data.role = "member";
    data.gender = gender;
              ...
              <div className="py-10">
                ...
                <div>
                  ...
                  >
                    ...
                    />
                    <section>
                      <div className="flex items-center bg-gray-100 p-1 w-full rounded-xl mt-3">
                        <DatePicker
                          onChange={handleDateOfBirth}
                          bordered={false}
                          placeholder="Date of Birth"
                          className="flex-1 outline-none h-full bg-transparent font-light"
                          size="large"
                        />
                      </div>
                    </section>
                    ...
                    <section>
                      <div className="flex items-center bg-gray-100 p-2 w-full rounded-xl mt-3">
                        <MdWorkOutline className=" m-2 text-gray-400" />
                        <input
                    ...
                    <section className="relative">
                      <div className="flex items-center bg-gray-100 w-full p-2 rounded-xl mt-3">
                        <IoHomeOutline className=" m-2 text-gray-400 absolute left-[8px]" />
                        <Select
                          className="flex-1 outline-none h-full bg-transparent text-sm text-gray-400 pl-[14px]"
                          bordered={false}
                          onSelect={(value) => handleHometown(value)}
                          allowClear
                    ...
                    <section className="relative">
                      <div className="flex items-center bg-gray-100 w-full p-2 rounded-xl mt-3">
                        ...
                        <Select
                          className="flex-1 outline-none h-full bg-transparent text-sm text-gray-400"
                          bordered={false}
                          onSelect={(value) => handleGender(value)}
                          allowClear
                    ...
                    <div className="col-span-2 mt-5">
                      <button
                        ...
                        className="hover:px-12 px-12 py-2 hover:py-2 special_profile_button_hover duration-500 transition-all"
                        disabled={serverLoading}
                      >
                        {serverLoading ? "Loading..." : "SIGN UP"}
                      </button>
                    </div>
                  </form>
                </div>
