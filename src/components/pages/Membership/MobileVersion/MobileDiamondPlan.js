...
const MobileDiamondPlan = () => {
    const diamondPlanInfo = [
        { id: 1, text: "All Features Of Gold" },
        { id: 2, text: "+ 2 Hours of Video Chat" },
        { id: 3, text: "+ 50% Course Fee Off" },
        { id: 4, text: "+ 5% Shopping Discount" },
        { id: 5, text: "+ 5% Discount on Lawyer Fee" },
        { id: 6, text: "+ 10% Discount on Agent Fee" },
    ]
    return (
        <div>
            <MobileMembershipHeader planTitle={"Diamond"} />
            <section>
                ...
                <div>
                    <p className='ml-[30px]'>
                        <span className='text-[#E41272] text-[54px] leading-[66px] font-bold mr-2'>$499</span>
