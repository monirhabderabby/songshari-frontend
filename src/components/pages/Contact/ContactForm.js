...
export const ContactForm = () => {
  ...
  return (
    <div className="max-w-[1200px] mx-auto">
      <div className="container my-4 md:my-24 px-6 mx-auto">
        <section className="mb-12 md:mb-32 text-gray-800">
          <div className="flex flex-wrap">
            <div className="grow-0 shrink-0 basis-auto mb-6 md:mb-0 w-full md:w-6/12 px-3 lg:px-6">
              <h2 className="text-3xl font-bold my-6">Contact Shongshari</h2>
              <div className="flex">
                <EmailIcon style={{ color: "#e32986" }} />
                <span className="ml-3 underline font-bold text-gray-500 mb-2">
                  itco.com.bd@gmail.com
                </span>
              </div>
            </div>
