    ...
    <div>
      ...
      <div className='grid lg:grid-cols-3 gap-4 container ml-12 mb-4'>
          ...
          <CardContent className='grid lg:grid-cols-2'>
            ...
            <div>
              ...
              <Typography variant="body2" sx={{ color: 'white' }} >
                <i className="fa-solid fa-calendar-days mt-2 mr-2"></i> September 8, 2023
              </Typography>
            </div>
          </CardContent>
        </Card>
        ...
        <Card sx={{ maxWidth: 345, backgroundColor: '#40268B', color: 'white' }}>
          <CardContent className='grid lg:grid-cols-2'>
            <div>
              <img src='https://i.ibb.co/KmhRxrm/Rectangle-714-3.png' alt='Not Available'></img>
            </div>
            <div>
              <Typography variant="body2" sx={{ fontSize: 14, color: 'white' }} color="text.secondary">
                A example lawyer service for the married person
      ...
      <div className='grid lg:grid-cols-3 gap-4 container ml-12'>
        <Card sx={{ maxWidth: 345, backgroundColor: '#40268B', color: 'white' }}>
          <CardContent className='grid lg:grid-cols-2'>
            <div>
              <img src='https://i.ibb.co/tZS2Ldc/Rectangle-714-5.png' alt='Not Available'></img>
            </div>
            <div>
              <Typography variant="body2" sx={{ fontSize: 14, color: 'white' }} color="text.secondary">
                A example lawyer service for the married person
        ...
        <Card sx={{ maxWidth: 345, backgroundColor: '#40268B', color: 'white' }}>
          <CardContent className='grid lg:grid-cols-2'>
            <div>
              <img src='https://i.ibb.co/yRPNCbh/Rectangle-714-4.png' alt='Not Available'></img>
            </div>
            <div>
              <Typography variant="body2" sx={{ fontSize: 14, color: 'white' }} color="text.secondary">
                A example lawyer service for the married person
        ...
        <Card sx={{ maxWidth: 345, backgroundColor: '#40268B', color: 'white' }}>
          <CardContent className='grid lg:grid-cols-2'>
            <div>
              <img src='https://i.ibb.co/jMSTWdQ/Rectangle-714-2.png' alt='Not Available'></img>
            </div>
            <div>
              <Typography variant="body2" sx={{ fontSize: 14, color: 'white' }} color="text.secondary">
                A example lawyer service for the married person
