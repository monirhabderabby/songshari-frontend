...
const DynamicSingleServiceDetailes = () => {
    ...
    const { service } = data || {};
    const { _id, title, description, photos, recuirements, extraOffer, price, deadline, role, priceInPoint } = service || {};
                    ...
                    <div>
                        ...
                        <div className="flex justify-between items-start">
                            ...
                            <div className="hidden lg:block">
                                <DynamicSingleServiceOrderCard {...{ price, deadline, role, _id, priceInPoint }} />
                            </div>
