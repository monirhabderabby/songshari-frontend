      ...
      <div className="bg-[#FFFFFF] py-[10px] sticky top-0">
        <div className="bg-white w-full grid grid-cols-6 h-[48px]">
          ...
          <div className="col-span-4 ">
            <p className="text-center">Edit Sibling Details</p>
          </div>
          <div className="col-span-1"></div>
        </div>
      </div>
      <div>
        <div className="mx-auto bg-white drop-shadow-lg p-4 mb-4 rounded">
...
export default MobileSiblingsInfoEdit;
