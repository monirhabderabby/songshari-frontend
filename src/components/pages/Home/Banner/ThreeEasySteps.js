...
const ThreeEasySteps = () => {
    ...
    return (
        <div
            ...
            className="relative w-11/12 md:w-4/5 mx-auto mt-8 md:mt-0"
        >
            <div
                className=" md:absolute md:bottom-[-75px] z-10 py-5 px-10 w-full rounded-3xl md:rounded-full bg-white"
                style={{ boxShadow: "0px 10px 30px 0px rgb(38 14 116 / 40%)" }}
            >
                <div className="flex flex-col md:flex-row gap-4 md:gap-0 items-center">
                    <div className="flex-[35%] md:pr-16">
                    ...
                    <div className='flex-[50%]'>
                        <div className='relative flex flex-col md:flex-row justify-center items-center gap-10 py-3 md:border-l border-black text-center'>
                            {
