...
const BeginFamilyJourney = () => {
    return (
        <div className="pt-8 pb-24 w-4/5 mx-auto">
            <div className="flex">
                <div data-aos="fade-right" data-aos-easing="ease-out-cubic" data-aos-duration="1000" className="flex-1">
                ...
                <div data-aos="fade-left" data-aos-easing="ease-out-cubic" data-aos-duration="1000" className="flex-1 relative text-center">
