        ...
        <div className="custom-container max-w-[1200px] pt-8 pb-24 w-11/12 lg:w-4/5 mx-auto">
            <div className="flex flex-col md:flex-row">
                <div data-aos="fade-right" data-aos-easing="ease-out-cubic" data-aos-duration="1000" className="md:flex-1">
                    ...
                    <h2 className="text-4xl lg:text-5xl font-bold mb-3 md:mb-1 lg:mb-3 text-[#292929]">Begin Family Journey</h2>
                    <p className="md:mr-8 mb-4 md:mb-2 lg:mb-4 text-xl md:text-lg lg:text-[16px] tracking-wide md:tracking-normal lg:tracking-wide md:leading-tight lg:leading-normal">
                    ...
                    <p className="md:mr-8 mb-4 md:mb-1 lg:mb-4 text-[14px] md:text-lg lg:text-[16px] tracking-wide md:tracking-normal lg:tracking-wide md:leading-tight lg:leading-normal">
