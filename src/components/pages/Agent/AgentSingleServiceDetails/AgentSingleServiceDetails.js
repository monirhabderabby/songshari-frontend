...
import AgentSingleServiceImages from "./AgentSingleServiceImages/AgentSingleServiceImages";
import AgentSingleServiceReviewCard from "../../../shared/Cards/Agent/AgentSingleServiceReviewCard";
import AgentSingleServicePrizeReviewDetails from "./AgentSingleServicePrizeReviewDetails/AgentSingleServicePrizeReviewDetails";

const AgentSingleServiceDetails = () => {
  const { id } = useParams();
      ...
      <div>
        ...
        <div className="flex justify-between items-start">
          <div className="max-w-[819px]">
            <AgentSingleServiceImages {...{ serviceDetails }} />
            <div>
          ...
          <AgentSingleServicePrizeReviewDetails {...{ serviceDetails }} />
        </div>
      </div>
    </div>
  );
...
export default AgentSingleServiceDetails;
