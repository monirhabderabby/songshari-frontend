...
// Components
import AgentActivityPendingCaseCard from "../../../../shared/Cards/Agent/AgentActivityPendingCaseCard";

const AgentActivityPendingCase = () => {
    ...
    <div className="mb-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-12 mb-16">
        {pendingCasesInfo.map((caseInfo) => (
          <AgentActivityPendingCaseCard key={caseInfo.id} {...{ caseInfo }} />
        ))}
      </div>
...
export default AgentActivityPendingCase;
