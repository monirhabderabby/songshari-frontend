...
// Components
import AgentBestTwoReviewsCard from "../../../../shared/Cards/Agent/AgentBestTwoReviewsCard";
import AgentBestReviewsCard from "../../../../shared/Cards/Agent/AgentBestReviewsCard";

const AgentRecentReview = ({ reviewsData }) => {
      ...
      <div className="lg:max-w-[1000px] xl:max-w-[1200px] mx-auto py-20 mb-24">
        ...
        <div className="grid grid-cols-2 gap-8 mb-20">
          {bestReviews.slice(0, 2).map((review) => (
            <AgentBestTwoReviewsCard key={review.id} {...{ review }} />
          ))}
        </div>
        {/* Best reviews */}
        <div className="grid grid-cols-3 gap-8 px-28">
          {topReviews.slice(0, 6).map((review) => (
            <AgentBestReviewsCard key={review.id} {...{ review }} />
          ))}
        </div>
      </div>
    </div>
...
export default AgentRecentReview;
