...
export const WalletHeader = () => {
    ...
    return (
        <div className="w-full flex justify-evenly gap-x-[10px]">
            ...
            <div onClick={()=>setOpen(true)} className="bg-[rgba(37,188,241,0.15)] w-full lg:w-[300px] min-h-[130px] h-auto flex flex-col items-center justify-evenly rounded-[4px] hover:shadow-md duration-300 cursor-pointer">
