...
const LatestRegisteredMember = () => {
  ...
  return (
    <>
      <section
        className={`${LatestRegisteredMemberCSS.latestRegisteredSection} font-Poppins`}
      >
        <img
          className={LatestRegisteredMemberCSS.shape}
          src={shape}
          alt="Not Available"
        />
            ...
            <div className="w-[30%] ">
              <div className={LatestRegisteredMemberCSS.content}>
                <div className={LatestRegisteredMemberCSS.sectionHeader}>
                  <h6 className="text-[#ff317b] text-[24px] mb-[5px] font-bold">
                    Latest Registered
                  </h6>
                      ...
                      <div className="-z-20">
                        <div className="text-center">
                          ...
                          <div className="inner-content">
                            <h4 className="text-[#fffff9]/70 text-[12px]">
                              {data?.designation || "Not Added"}
                            </h4>
                          </div>
                          <div className="inner-content">
                            <h4 className="text-[#fffff9]/70 text-[12px]">
                              {data?.citizenShip[0] || "Not Added"}
                            </h4>
                          </div>
                        </div>
                      </div>
