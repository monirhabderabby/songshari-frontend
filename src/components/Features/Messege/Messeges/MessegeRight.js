...
export const MessegeRight = ({ profile, message, index }) => {
    ...
    return (
        <motion.div ref={scrollRef} className="flex w-full justify-end gap-x-[20px] my-[51px]">
            ...
            <img className="h-[40px] w-[40px] mt-1 rounded-full" src={profilePhotoDecisionMaker(profile?.profilePhoto)} alt="profile" />
        </motion.div>
    );
};
