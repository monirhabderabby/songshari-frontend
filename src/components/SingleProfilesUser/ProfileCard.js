        ...
        <div className="rounded-xl w-full">
            ...
            >
                ...
                <div className="relative lg:w-52 h-52 rounded-full">
                    <div className="bottom-[120px]  left-[100px] absolute">
                        <div className="relative w-[160px] h-[160px] bg-white rounded-full flex justify-center items-center">
                            <img
                                className="w-[140px] h-[140px] rounded-full img-fluid"
