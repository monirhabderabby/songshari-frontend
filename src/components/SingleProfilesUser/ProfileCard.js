...
import { AiFillCamera, AiOutlinePlayCircle } from "react-icons/ai";
        ...
        content = (
          ...
          >
            ...
            <div className="w-full flex justify-center items-center absolute top-[70%]">
              ...
              {age>0 && <div className="h-[28px] w-[4px] bg-gray-200 rounded-[4px] mx-[5px]"></div>}
              <div className="flex items-center">
                ...
                {data?.hometown && <div className="h-[28px] w-[4px] bg-gray-200 rounded-[4px] mx-[5px]"></div>}
                {data?.userMatrimonyPackageInfo && <button className="special_profile_button text-sm">
