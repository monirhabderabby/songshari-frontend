...
const ResponsiveTable = ({ data, isLoading }) => {
    ...
    return (
        <div>
            {/* responsive for tab version  */}
            <div className="mb-4 w-full md:block hidden lg:hidden">
                <div className="w-full h-[60px] lg:max-w-[512px] mx-auto bg-white mb-[20px] shadow-[rgba(100,100,111,0.2)_0px_7px_29px_0px] rounded-[4px]">
                    <div className="flex justify-center items-center h-full gap-4">
                        ...
                        <button
                            ...
                            onClick={() => setPage(3)}
                        >
                            Services <sup className="text-white bg_Color px-2 py-1 rounded-full text-[12px]">1</sup>
                        </button>
                        <button
                        ...
                        >
                            Connections{" "}
                            <sup className="text-white bg_Color px-2 py-1 rounded-full text-[12px]">{data?.connectionRequests?.length}</sup>
                        </button>
                        <button
                            className={`font-medium text-[15px] leading-tight ${page === 5 ? "text-primary font-bold" : "text-gray-800"}`}
                            onClick={() => setPage(5)}
                        >
                            Matches <sup className="text-white bg_Color px-2 py-1 rounded-full text-[12px]">1</sup>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-4 w-full md:hidden lg:hidden">
                <div className="w-full h-[60px] lg:max-w-[512px] mx-auto bg-white mb-[20px] shadow-[rgba(100,100,111,0.2)_0px_7px_29px_0px] rounded-[4px]">
                    <div className="flex justify-center items-center h-full gap-4">
                        <button
                            className={`font-medium text-[12px] leading-tight ${page === 1 ? "text-primary font-bold" : "text-gray-800"}`}
                            onClick={() => setPage(1)}
                        >
                            Activity
                        </button>
                        <button
                            className={`font-medium text-[12px] leading-tight ${page === 2 ? "text-primary font-bold" : "text-gray-800"}`}
                            onClick={() => {
                                navigate("/userprofile");
                                setPage(2);
                            }}
                        ...
                        <button
                            className={`font-medium text-[12px] leading-tight ${page === 3 ? "text-primary font-bold" : "text-gray-800"}`}
                            onClick={() => setPage(3)}
                        >
                            Services <sup className="text-white bg_Color px-2 py-1 rounded-full text-[12px]">1</sup>
                        </button>
                        <button
                            className={`font-medium text-[12px] leading-tight ${page === 4 ? "text-primary font-bold" : "text-gray-800"}`}
                            onClick={() => setPage(4)}
                        >
                            Connections{" "}
                            <sup className="text-white bg_Color px-2 py-1 rounded-full text-[12px]">{data?.connectionRequests?.length}</sup>
                        ...
                        <button
                            className={`font-medium text-[12px] leading-tight ${page === 5 ? "text-primary font-bold" : "text-gray-800"}`}
                            onClick={() => setPage(5)}
                        >
                            Matches <sup className="text-white bg_Color px-2 py-1 rounded-full text-[12px]">1</sup>
                        </button>
