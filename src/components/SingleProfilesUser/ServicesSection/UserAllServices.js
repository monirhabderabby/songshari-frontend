...
const UserAllServices = () => {
    ...
    return (
        <div>
            ...
            <section>
                {
                    servicesInfo.map(service => <div
                        key={service.id}
                        className="bg-[#FDF8E7] rounded-xl p-5 mb-6"
                    >
                        <div>
                            <img className='w-full h-48 rounded-xl' src={service.serviceImage} alt="" />
                        </div>
                        <h2 className='text-lg leading-6 font-medium my-4'>
                            {service.serviceHeading}
                        </h2>
                        <p className='text-sm leading-[18px] text-[#666666] mb-4'>
                            {service.serviceDescription}
                        </p>
                        <h4 className='text-sm leading-[18px] font-medium mb-4'>
                            {service.serviceProviderName}
                        </h4>
                        <div className='flex justify-between items-center'>
                            <div className='flex items-center gap-[6px]'>
                                <div className='bg-[#DEDEDE] w-4 h-4 rounded-full'></div>
                                <p className='text-sm leading-[18px] text-[#666666]'>
                                    {service.providerDesignation}
                                </p>
                            </div>
                            <div className='flex items-center gap-4'>
                                ...
                                <button className='text-sm text-white leading-[18px] font-semibold px-5 py-1 bg-[#E41272] rounded'>
                                    View
                                </button>
                            </div>
                        </div>
