...
import { useGetProfileDetailsWIthAuthQuery, useSetPersonalDetailsMutation } from "../../../Redux/features/userInfo/userApi";
...
const MobileUsersProfile = () => {
    ...
    const [setPersonalDetails, { data: profileOrCoverPhotoResponse }] = useSetPersonalDetailsMutation();
    ...
    useEffect(() => {
        if (uploadedProfilePhoto) setPersonalDetails({ profilePhoto: uploadedProfilePhoto?.data[0]?.path });
            ...
            <div className="flex justify-center mt-4">
                <div className="w-full">
                    ...
                    <label htmlFor="uploadCoverPhoto" className="relative">
                        ...
                        <input type="file" id="uploadCoverPhoto" name="uploadCoverPhoto" className="hidden" onChange={coverPhotoUploadHandler} />
                        <div className="absolute right-1 md:right-2 flex items-center px-1 md:px-2 bg-white group rounded-xl bottom-[5%] shadow-md md:shadow-lg">
                            <span className="text-[11px] md:text-base font-semibold">Edit Cover Photo</span>
                            ...
                            <div>
                                <div className="flex items-end justify-between">
                                    ...
                                    <div className="w-[125px] mr-2 pb-4">
                                        {SocialBoxOpen && <MobileSocialMediaBox {...{ LinkedInId, faceBookId, instagramId }} />}
                                    </div>
                                </div>
                            </div>
                        </div>
