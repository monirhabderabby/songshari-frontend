...
export const Badges = ({ data, error }) => {
    return (
        <motion.div
            ...
            className="mt-[24px] lg:w-full h-[125px] bg-white shadow-[0px_10px_5px_rgba(119,123,146,0.02)] rounded-[10px] py-[16px] px-[20px]"
        >
            <div>
                ...
                {error && (
                    <div className="mt-[30px]">
                        <div className="flex text-xl font-bold text-yellow-400 items-center gap-x-[16px]">Server error</div>
                    </div>
                )}
            </div>
        </motion.div>
