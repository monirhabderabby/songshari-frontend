...
const GoActivityPremiumCard = ({ canPost, setCanPost }) => {
  return (
    <>
      <div onClick={()=>setCanPost(true)} className="fixed w-full h-full inset-0 z-10 bg-black/50 cursor-pointer"></div>
...
export default GoActivityPremiumCard;
