        ...
        <div>
            <div className="utiliti-card my-6 flex items-center justify-around">
                <div className="w-16 h-16 flex items-center justify-center rounded-full bg-pink-100">
                    ...
                    >
                        <svg color="#FF1D8E" className="w-8 h-8" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="w-16 h-16 flex items-center justify-center rounded-full bg-pink-100">
                    <button
                        ...
                        className="w-12 h-12 rounded-full inline-flex relative items-center p-2 text-sm font-medium text-center"
                    >
                        <svg color="#FF1D8E" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
