...
export const VerificationCard = () => {
    return (
        <div className="mt-[24px] w-[360px] h-[125px] bg-white shadow-[0px_10px_5px_rgba(119,123,146,0.02)] rounded-[10px] py-[16px] px-[20px]">
            <section className="flex flex-col justify-around h-full w-full">
