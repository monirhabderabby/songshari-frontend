            ...
            <div className="max-w-[523px] mx-auto bg-white drop-shadow-lg px-4 pt-3 pb-6 mb-4 rounded">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="pb-4">
                        ...
                        <Slider min={0} max={200} onChange={onHeightChange} onAfterChange={onAfterHeightChange} />
                    </div>
                    ...
                    <div className="pb-4">
                        ...
                        <Slider onChange={onWeightChange} onAfterChange={onAfterWeightChange} min={0} max={200} />
                    </div>
