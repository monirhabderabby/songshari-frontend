            ...
            <Accordion expanded={expanded === "panel2"} onChange={handleChange("panel2")}>
                <div className="flex justify-between items-center	">
                    <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
                        <div>
                            <Typography component={"span"} variant={"body2"} className="hidden md:block">
                                <h1 className="text-[24px] text-[#333333] leading-[34px] font-fira font-semibold">Professional Information</h1>
                            </Typography>
                            <Typography component={"span"} variant={"body2"} className="md:hidden">
                                <h1 className="text-[18px] text-[#333333] leading-[34px] font-fira">Professional Information</h1>
                            </Typography>
                        </div>
                    </AccordionSummary>
                    <div
